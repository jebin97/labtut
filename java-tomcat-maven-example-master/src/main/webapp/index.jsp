<html lang="en">
  <head>
    ...
    <title>Nissan Digital India</title>
	...
	.banner-nissan {
	  ...
	  min-height: 20%;
	  min-width: 30%;
	  background-image: url("cassi.jpg");
		 ...
		 <div class="row">
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
               <img class="card-img-top" src="thumbnail.svg" alt="Card image cap">
                <div class="card-body">
                  <p class="card-text">Achieve Your Dreams- by Mohit Anand</p>
                  <p class="card-text">Dont achieve Your Dreams- by Mohit Anand</p>
